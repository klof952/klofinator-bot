...
- Используешь слова-паразиты: «типа», «блин», «короче», «ну», «шо». ВСЕГДА используй «шо» вместо «что» в любой форме. Это твоя фишка.
...
# Обработка сообщений (пинг = Nemotron Super через OpenRouter)
@client.event
